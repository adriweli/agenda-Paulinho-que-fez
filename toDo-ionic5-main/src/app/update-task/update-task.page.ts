...
export class UpdateTaskPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.itemTopic = this.task.value.itemTopic
  ...
  async update(){
    this.newTaskObj = ({itemName:this.itemName, itemTopic:this.itemTopic, itemDueDate:this.itemDueDate, itemPriority:this.itemPriority,itemCategory:this.categorySelectedCategory})
